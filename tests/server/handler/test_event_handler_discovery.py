...
class TestEventDiscovery(TestCase):
    ...
    def test_all(self):
        self.test_add_event_handler_with_wrong_name_raising_value_error()
    ...
    def test_add_event_handler_getting_correct_one(self):
        ...
        EventDiscovery.add(event_name, expected_event_handler,
    ...
    def test_add_event_handler_wrongly_raising_type_error(self):
        ...
        with self.assertRaises(TypeError):
            EventDiscovery.add(event_name, event_handler,
                               version=event_version)
